...
const Index = () => {
  ...
  // La section /advanced-search est supprimée. Aucune redirection implicite.



  // Sync activeSection with URL
  useEffect(() => {
    // Ne considérer que le premier segment comme section logique
