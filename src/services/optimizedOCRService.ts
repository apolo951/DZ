...
import { loadPDFJS } from '@/services/ocrService';
...
const huggingFaceCache: any = null;
let isLoading = false;
...
async function loadHuggingFaceModels() {
  ...
  try {
    ...
    throw new Error('Advanced AI models temporarily disabled due to technical issues');
