...
type LogCategory = 
  ...
  | 'PROCESSING' | 'EXTRACTION' | 'MAPPING' | 'ImageProcessing' | 'TableExtraction'
  | 'OCR_MONITORING' | 'PDFProcessing' | 'AdvancedTesting' | 'AdvancedAlgorithms' 
  | 'PerformanceMonitoring' | 'Supabase'; // Ajout des catégories manquantes
