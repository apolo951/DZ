...
export const menuItems = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Diagnostics OCR", section: "ocr-diagnostics", path: "/ocr-diagnostics" }
    ]
  },
  {
    id: "analyse-rapports",
    ...
    submenu: [
      ...
      { label: "Carte Densité par wilaya", section: "analytics-algeria" },
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Sources (Supabase)", section: "sources" }
    ]
  }
];
