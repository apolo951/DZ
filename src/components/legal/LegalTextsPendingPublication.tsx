    ...
    const pendingDocuments = [
      {
        ...
        type: 'Loi',
        legalCategory: 'loi' as const,
        insertionType: 'ocr' as const,
        ...
        status: 'approved_pending_publication' as const,
        confidence: 96.5,
      ...
      },
      {
        ...
        legalCategory: 'decret' as const,
        insertionType: 'manual' as const,
        ...
        comments: [
          {
            ...
            type: 'publication_note' as const
          }
        ],
        ocrData: {
          numero: '25-125',
      ...
      },
      {
        ...
        type: 'Ordonnance',
        legalCategory: 'ordonnance' as const,
        insertionType: 'manual' as const,
        ...
        status: 'publication_delayed' as const,
        confidence: 100,
        priority: 'high' as const,
        approvedBy: 'Dr. Ahmed Benali',
        comments: [
