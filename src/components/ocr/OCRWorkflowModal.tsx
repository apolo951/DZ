                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                          <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="flex items-center gap-2">
                              <div className={`text-2xl font-bold ${extractionData.confidence >= 0.8 ? 'text-green-600' : extractionData.confidence >= 0.6 ? 'text-yellow-600' : 'text-red-600'}`}>
                                {Math.round(extractionData.confidence * 100)}%
                              </div>
                          ...
                          <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p className="text-sm text-gray-600">
                              {extractionData.metadata?.language === 'mixed' ? 'Bilingue (Français + Arabe)' :
                               extractionData.metadata?.language === 'ara' ? 'Arabe' : 
                               extractionData.metadata?.language === 'fra' ? 'Français' : 'Automatique'}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4 mb-6">
                          <div className="grid grid-cols-3 gap-4 text-sm">
                            <div className="bg-blue-50 p-3 rounded-lg">
                              <div className="font-bold text-lg text-blue-800">{extractionData.textLength || 0}</div>
                              <div className="text-blue-600">Mots</div>
                            </div>
                            <div className="bg-green-50 p-3 rounded-lg">
                              <div className="font-bold text-lg text-green-800">{extractionData.processingTime || 0}ms</div>
                          ...
                          <details className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="mt-3 space-y-2 text-sm">
                              <div><strong>Caractères totaux:</strong> {extractionData.metadata?.totalCharacters || extractionData.textLength || 0}</div>
                              <div><strong>Caractères arabes:</strong> {extractionData.metadata?.arabicCharacters || 0}</div>
                              <div><strong>Caractères français:</strong> {extractionData.metadata?.frenchCharacters || 0}</div>
                              <div><strong>Mode de traitement:</strong> {extractionData.metadata?.processingMode || 'Automatique'}</div>
                              <div><strong>Préprocessing:</strong> {extractionData.metadata?.preprocessingType || 'Standard français'}</div>
