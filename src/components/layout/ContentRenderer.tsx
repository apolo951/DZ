...
import { DiagnosticsOCRPage } from "@/components/ocr/diagnostics/DiagnosticsOCRPage";
...
import { AlgeriaDensitySection } from "@/components/analytics/AlgeriaDensitySection";
...
export function ContentRenderer({ activeSection, language, refreshTrigger }: ContentRendererProps) {
  switch (activeSection) {
    ...
    case "sources-management":
      return <SourcesSection language={language} />;
      ...
      return (
        <div className="space-y-8">
            <SectionHeader
              ...
              description="Protection de la vie privée et des données personnelles conformément à la législation algérienne."
      ...
      return (
        <div className="space-y-8">
            <SectionHeader
              ...
              description="Règles d'utilisation du service dalil.dz de la République Algérienne Démocratique et Populaire."
              iconColor="text-teal-600"
            />
    ...
    // AI sections (ai-advanced accessible inside AI Assistant tabs only)
    ...
    // removed: case "advanced-search": return <AdvancedSearchSection />;
    // saved-searches remains accessible within Legal and Procedures tabs
    
    case "analytics-algeria":
      return <AlgeriaDensitySection />;
