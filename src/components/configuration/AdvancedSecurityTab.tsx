...
import { TwoFactorTOTPPanel } from '@/components/security/TwoFactorTOTPPanel';
import { ClientSideEncryptionPanel } from '@/components/security/ClientSideEncryptionPanel';
import { Input } from '@/components/ui/input';
import { RuntimeConfigBlock } from '@/components/configuration/RuntimeConfigBlock';
...
export function AdvancedSecurityTab({ language = "fr" }: AdvancedSecurityTabProps) {
  ...
  useEffect(() => {
    try {
      ...
      console.warn('Failed to load security configuration from localStorage:', error);
    }
  }, []);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Bloc RuntimeConfigBlock déplacé ici */}
      <RuntimeConfigBlock />
